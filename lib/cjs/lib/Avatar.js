...
var extendStyles = function (variant, size, styles) {
    ...
    var dims;
    switch (variant) {
        case types_1.EAvatarVariant.entity:
            borderRadius = "0.1875rem";
            break;
        case types_1.EAvatarVariant.bot:
            borderRadius = "0";
            switch (size) {
                case "large":
...
var Avatar = function (_a) {
    var name = _a.name, image = _a.image, styles = _a.styles, variables = _a.variables, _b = _a.size, size = _b === void 0 ? "small" : _b, _c = _a.variant, variant = _c === void 0 ? types_1.EAvatarVariant.human : _c;
    return (react_1.default.createElement(react_northstar_1.Avatar, __assign({}, (image && { image: image }), { name: name, size: size, variables: variables }, extendStyles(variant, size, styles))));
};
