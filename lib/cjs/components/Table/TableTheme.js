...
exports.TableTheme = function (_a) {
    var _b;
    ...
    return (react_1.default.createElement(react_northstar_1.Provider, { theme: react_northstar_1.mergeThemes(mainTheme, withTheme_1.teamsNextVariableAssignments, getLocalTheme(globalTheme.siteVariables.theme)) }, children));
};
