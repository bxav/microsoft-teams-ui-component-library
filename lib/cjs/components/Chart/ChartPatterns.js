...
exports.buildPattern = exports.Shape = exports.Entity = exports.chartBubbleDataPointPatterns = exports.chartBarDataPointPatterns = exports.chartLineStackedDataPointPatterns = exports.legendLabels = exports.lineChartPatterns = void 0;
...
var SIZE = 20;
exports.lineChartPatterns = [
    { lineBorderDash: [], pointStyle: ChartTypes_1.EPointStyles.Circle },
    { lineBorderDash: [], pointStyle: ChartTypes_1.EPointStyles.Rectangle },
    { lineBorderDash: [], pointStyle: ChartTypes_1.EPointStyles.Triangle },
    { lineBorderDash: [5, 5], pointStyle: ChartTypes_1.EPointStyles.Circle },
    { lineBorderDash: [5, 5], pointStyle: ChartTypes_1.EPointStyles.RectangleRotated },
    { lineBorderDash: [5, 5], pointStyle: ChartTypes_1.EPointStyles.Triangle },
];
exports.legendLabels = function (_a) {
    ...
    if (theme === themes_1.TeamsTheme.HighContrast) {
        if (patterns) {
            ...
            switch (exports.lineChartPatterns[index].pointStyle) {
                case ChartTypes_1.EPointStyles.Triangle:
                    ctx.moveTo(9.5, 2.5);
                    ctx.lineTo(5.5, 7.5);
                    ctx.lineTo(13.5, 7.5);
                    break;
                case ChartTypes_1.EPointStyles.Rectangle:
                    ctx.rect(6.5, 2.5, 8, 5);
                    break;
                case ChartTypes_1.EPointStyles.RectangleRotated:
                    ctx.moveTo(10, 2);
                    ctx.lineTo(14.5, 5);
                    ctx.lineTo(10, 8);
                    ctx.lineTo(5.5, 5);
                    break;
                case ChartTypes_1.EPointStyles.Circle:
                default:
            ...
            ctx.beginPath();
            ctx.setLineDash(exports.lineChartPatterns[index].lineBorderDash.length ? [2, 2] : []);
            ctx.moveTo(-1.5, 5);
            ctx.lineTo(20, 5);
            ctx.stroke();
            ctx.restore();
...
exports.chartLineStackedDataPointPatterns = function (colorScheme) {
    return [
        {
            shapeType: ChartTypes_1.EShapes.Square,
            size: 10,
        },
        {
            shapeType: ChartTypes_1.EShapes.DiagonalRightLeft,
            size: 5,
        },
        {
            shapeType: ChartTypes_1.EShapes.Grid,
            size: 10,
        },
        {
            shapeType: ChartTypes_1.EShapes.VerticalLine,
            size: 10,
        },
        {
            shapeType: ChartTypes_1.EShapes.GridRightLeft,
            size: 3,
        },
        {
            shapeType: ChartTypes_1.EShapes.Diagonal,
            size: 5,
        },
    ];
};
exports.chartBarDataPointPatterns = function (colorScheme) {
    return [
        {
            shapeType: ChartTypes_1.EShapes.DiagonalRightLeft,
            size: 5,
...
exports.chartBubbleDataPointPatterns = function (colorScheme) {
    return [
        {
            shapeType: ChartTypes_1.EShapes.DiagonalRightLeft,
            size: 5,
...
var shapes = (_a = {},
    _a[ChartTypes_1.EShapes.Square] = Square,
    _a[ChartTypes_1.EShapes.DiagonalRightLeft] = DiagonalRightLeft,
    _a[ChartTypes_1.EShapes.Grid] = Grid,
    _a[ChartTypes_1.EShapes.Diagonal] = Diagonal,
    _a[ChartTypes_1.EShapes.VerticalLine] = VerticalLine,
    _a[ChartTypes_1.EShapes.GridRightLeft] = GridRightLeft,
    _a);
