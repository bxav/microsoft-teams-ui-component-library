...
exports.BarHorizontalChart = void 0;
...
exports.BarHorizontalChart = function (_a) {
    ...
    react_1.useEffect(function () {
        ...
        if (!ctx)
            return;
        var config = ChartUtils_1.chartConfig({ type: "horizontalBar" });
        ...
        if (stacked) {
            ...
            config.options.tooltips.callbacks.title = function (tooltipItems) {
                ...
                return ((tooltipItems[0].xLabel / total) * 100).toPrecision(2) + "% (" + ChartUtils_1.usNumberFormat(tooltipItems[0].xLabel) + ")";
            };
        }
        chartRef.current = new chart_js_1.default(ctx, __assign(__assign({}, config), { data: {
            ...
            }, plugins: [
                {
                    afterDatasetsDraw: function (_a) {
                        ...
                        ChartUtils_1.horizontalBarValue({
                            chart: chart,
                            ctx: ctx,
                            stacked: stacked,
                        });
