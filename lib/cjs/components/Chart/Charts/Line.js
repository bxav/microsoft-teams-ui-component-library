...
exports.LineChart = function (_a) {
    ...
    var createAreaChartDataPoints = function (ctx) {
        return Array.from(data.datasets, function (set, i) {
            ...
            if (theme === themes_1.TeamsTheme.HighContrast) {
                var colorRGB = ChartUtils_1.hexToRgb(colorScheme.brand.background);
                var hoverColorRGB = ChartUtils_1.hexToRgb(colorScheme.default.borderHover);
                ...
                var colorRGB = ChartUtils_1.hexToRgb(chartDataPointColors[i]);
    ...
    react_1.useEffect(function () {
        ...
        if (!ctx)
            return;
        chartRef.current = new chart_js_1.default(ctx, __assign(__assign({}, ChartUtils_1.chartConfig({ type: "line" })), { data: {
    ...
    return (react_1.default.createElement(ChartContainer_1.ChartContainer, { siteVariables: siteVariables, data: data, chartDataPointColors: chartDataPointColors, onLegendClick: onLegendClick },
