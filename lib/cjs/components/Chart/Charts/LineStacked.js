...
exports.LineStackedChart = void 0;
...
exports.LineStackedChart = function (_a) {
    ...
    var createDataPoints = function () {
        return Array.from(data.datasets, function (set, i) {
            ...
            if (theme === themes_1.TeamsTheme.HighContrast) {
                dataPointConfig = __assign(__assign({}, dataPointConfig), { borderWidth: 3, hoverBorderColor: colorScheme.default.borderHover, hoverBorderWidth: 4, pointBorderColor: colorScheme.default.border, pointHoverBorderColor: colorScheme.default.borderHover, pointHoverRadius: 5, pointStyle: ChartPatterns_1.lineChartPatterns[i].pointStyle, borderColor: colorScheme.brand.background, backgroundColor: ChartPatterns_1.buildPattern(__assign(__assign({}, ChartPatterns_1.chartLineStackedDataPointPatterns(colorScheme)[i]), { backgroundColor: colorScheme.default.background, patternColor: colorScheme.brand.background })), hoverBackgroundColor: ChartPatterns_1.buildPattern(__assign(__assign({}, ChartPatterns_1.chartLineStackedDataPointPatterns(colorScheme)[i]), { backgroundColor: colorScheme.default.background, patternColor: colorScheme.default.borderHover })) });
            }
    ...
    react_1.useEffect(function () {
        ...
        if (!ctx)
            return;
        var config = ChartUtils_1.chartConfig({ type: "line" });
        ...
        function resetChartStates() {
            ...
            if (siteVariables.theme === themes_1.TeamsTheme.HighContrast) {
                chartRef.current.data.datasets.map(function (dataset, i) {
                    ...
                    dataset.backgroundColor = ChartPatterns_1.buildPattern(__assign(__assign({}, ChartPatterns_1.chartLineStackedDataPointPatterns(colorScheme)[i]), { backgroundColor: colorScheme.default.background, patternColor: colorScheme.brand.background }));
                });
                chart.update();
            }
    ...
    react_1.useEffect(function () {
        ...
        ChartUtils_1.setTooltipColorScheme({
            ...
            patterns: ChartPatterns_1.chartLineStackedDataPointPatterns,
        });
        // Update axeses
    ...
    return (react_1.default.createElement(ChartContainer_1.ChartContainer, { siteVariables: siteVariables, data: data, chartDataPointColors: chartDataPointColors, patterns: ChartPatterns_1.chartLineStackedDataPointPatterns, onLegendClick: onLegendClick },
