...
exports.tooltipConfig = exports.setTooltipColorScheme = exports.axesConfig = exports.chartConfig = exports.horizontalBarValue = exports.tooltipAxisXLine = exports.tooltipAxisYLine = exports.tooltipTrigger = exports.usNumberFormat = exports.hexToRgb = exports.chartAxisCallback = exports.random = void 0;
...
exports.chartAxisCallback = function (value) {
...
exports.usNumberFormat = function (value) {
    return String(value)
        .split("")
        .reverse()
        .join("")
...
function tooltipTrigger(_a) {
    ...
    if (mergeDuplicates) {
        ...
        if (theme === themes_1.TeamsTheme.HighContrast && patterns) {
            chart.data.datasets.map(function (dataset, i) {
                dataset.borderColor = colorScheme.default.border;
                dataset.borderWidth = 2;
                dataset.backgroundColor = ChartPatterns_1.buildPattern(__assign(__assign({}, patterns(colorScheme)[index]), { backgroundColor: colorScheme.default.background, patternColor: colorScheme.brand.background }));
            });
            chart.data.datasets[set].borderColor =
                siteVariables.colorScheme.default.borderHover;
            chart.data.datasets[set].borderWidth = 4;
            chart.data.datasets[set].backgroundColor = chart.data.datasets[set].backgroundColor = ChartPatterns_1.buildPattern(__assign(__assign({}, patterns(siteVariables.colorScheme)[set]), { backgroundColor: colorScheme.default.background, patternColor: colorScheme.default.borderHover }));
            chart.update();
        }
    }
...
exports.tooltipAxisYLine = function (_a) {
...
exports.tooltipAxisXLine = function (_a) {
    var chart = _a.chart, ctx = _a.ctx, tooltip = _a.tooltip;
    if (tooltip._active && tooltip._active.length) {
...
exports.horizontalBarValue = function (_a) {
...
exports.chartConfig = function (_a) {
    var type = _a.type;
    return ({
        type: type,
        options: {
            ...
            tooltips: exports.tooltipConfig(),
            scales: {
                xAxes: [
                    {
                        ticks: {
                            ...
                            maxRotation: 0,
                            minRotation: 0,
                            callback: exports.chartAxisCallback,
                        },
                        gridLines: {
                            borderDash: [5, 9999],
...
exports.axesConfig = function (_a) {
...
exports.setTooltipColorScheme = function (_a) {
    var _b;
    ...
    chart.options.tooltips = __assign(__assign({}, chart.options.tooltips), { backgroundColor: theme === themes_1.TeamsTheme.Dark
            ? colorScheme.default.border2
            : colorScheme.default.foregroundFocus, borderColor: colorScheme.default.borderHover, multiKeyBackground: colorScheme.white.foreground, titleFontColor: colorScheme.default.foreground3, bodyFontColor: colorScheme.default.foreground3, footerFontColor: colorScheme.default.foreground3, borderWidth: theme === themes_1.TeamsTheme.HighContrast ? 2 : 0, callbacks: __assign(__assign({}, (_b = chart.options.tooltips) === null || _b === void 0 ? void 0 : _b.callbacks), { labelColor: patterns && theme === themes_1.TeamsTheme.HighContrast
                ? function (tooltipItem) { return ({
                    borderColor: "transparent",
                    backgroundColor: ChartPatterns_1.buildPattern(__assign(__assign({}, patterns(colorScheme)[verticalDataAlignment
                        ? tooltipItem.index
...
exports.tooltipConfig = function () { return ({
    yPadding: 12,
    xPadding: 20,
    caretPadding: 10,
    // Tooltip Title
