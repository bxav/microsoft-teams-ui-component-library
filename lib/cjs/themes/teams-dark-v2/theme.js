...
exports.darkV2ThemeOverrides = void 0;
...
var tree_styles_1 = require("./components/Tree/tree-styles");
 ...
 */
exports.darkV2ThemeOverrides = {
    componentStyles: shared_1.mergeSharedComponentStyles({
        Alert: alert_styles_1.alertStyles,
        Flex: flex_styles_1.flexStyles,
        Tree: tree_styles_1.treeStyles,
    }),
    siteVariables: __assign(__assign({}, react_northstar_1.teamsDarkTheme.siteVariables), site_variables_1.default),
